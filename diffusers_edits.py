...
class StableDiffusionSafetyChecker(PreTrainedModel):
    ...
    @torch.no_grad()
    def forward(self, clip_input, images, adjustment=0.0, blank_nsfw=True):
        ...
        if any(has_nsfw_concepts):
            print("Probable NSFW content was detected")
        ...
        **kwargs,
        ...
        if not disable_safety_checker:
            ...
            image, has_nsfw_concept = self.safety_checker(images=image, clip_input=safety_cheker_input.pixel_values,
                adjustment=safety_adjustment, blank_nsfw=blank_nsfw)
        else:
            image, has_nsfw_concept = pipe.safety_checker = lambda images, clip_input: (images, [False] * len(images))
